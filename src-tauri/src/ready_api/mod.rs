...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            local_pool::accounts::mutations::set_local_account_draining,
            ...
            local_pool::commands::remote_server::create_remote_client_key,
            local_pool::commands::remote_server::update_remote_client_key,
            local_pool::commands::remote_server::rotate_remote_client_key,
            local_pool::commands::remote_server::revoke_remote_client_key,
