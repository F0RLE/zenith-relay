...
pub async fn get_local_runtime_state(
    ...
    Ok(RuntimeStateSnapshot {
        ...
        gateway: GatewaySummary {
            ...
            session_affinity: Some(snapshot.gateway.session_affinity),
            session_affinity_ttl_seconds: Some(snapshot.gateway.session_affinity_ttl_seconds),
            models,
    ...
    fn local_and_remote_snapshots_share_the_same_top_level_contract() {
        let local = serde_json::to_value(RuntimeStateSnapshot {
            ...
            gateway: GatewaySummary {
                ...
                session_affinity_ttl_seconds: Some(3_600),
                models: Vec::new(),
