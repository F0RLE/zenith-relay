...
export const relayCommands = {
  ...
  getResetCredits: (accountId: string) => invoke<ResetCreditsSnapshot>("get_local_reset_credits", { accountId }),
  ...
  probeModelReasoning: (modelId: string, level: string, addSuccessfulToSettings: boolean) => invoke<ModelReasoningProbeResult>("probe_local_model_reasoning", { input: { modelId, level, addSuccessfulToSettings } }),
