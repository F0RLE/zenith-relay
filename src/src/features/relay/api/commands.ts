...
import type {
  ...
  ImportSession,
  KeySummary,
  LocalGatewayKeyInput,
  LocalGatewayKeyUpdateInput,
  LocalUsage,
  LocalUsagePage,
...
export const relayCommands = {
  ...
  createKey: (input: LocalGatewayKeyInput) => invoke<{ key: KeySummary; secret: string }>("create_local_gateway_key", { input }),
  updateKey: (input: LocalGatewayKeyUpdateInput) => invoke("update_local_gateway_key", { input }),
  rotateKey: (keyId: string) => invoke<{ key: KeySummary; secret: string }>("rotate_local_gateway_key", { keyId }),
  ...
  restoreProfileSnapshot: (snapshotId: string, safetyName?: string | null) => invoke<void>("restore_codex_profile_snapshot", { snapshotId, safetyName: safetyName ?? null }),
