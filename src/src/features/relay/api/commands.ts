...
export const relayCommands = {
  ...
  restoreFullProfileSnapshot: (snapshotId: string, safetyName?: string | null) => invoke<void>("restore_full_codex_profile_snapshot", { snapshotId, safetyName: safetyName ?? null }),
