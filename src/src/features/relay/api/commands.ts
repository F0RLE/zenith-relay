...
export const relayCommands = {
  ...
  updateQuotaPolicy: (refreshIntervalSeconds: number, requestTimeoutSeconds: number) => invoke("update_local_quota_policy", { input: { refreshIntervalSeconds, requestTimeoutSeconds } }),
