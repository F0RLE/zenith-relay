...
export const relayCommands = {
  ...
  updateRouting: (routingStrategy: RoutingStrategy, maxRetryCandidates: number, sessionAffinity: boolean, sessionAffinityTtlSeconds: number) => invoke("update_local_routing", { input: { routingStrategy, maxRetryCandidates, sessionAffinity, sessionAffinityTtlSeconds } }),
