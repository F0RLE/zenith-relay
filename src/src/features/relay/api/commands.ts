...
export const relayCommands = {
  ...
  assignFreeProxies: (accountIds: string[]) => invoke<StoredProxyAssignmentResult>("assign_free_local_account_proxies", { input: { accountIds } }),
  ...
  createKey: (label: string, system = false) => invoke<{ key: KeySummary; secret: string }>("create_local_gateway_key", { label, system }),
